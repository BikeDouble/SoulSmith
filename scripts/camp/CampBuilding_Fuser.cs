...
{
	private double statRandRange = 0.2f;

	public CampBuilding_Fuser(int inputSlots, PackedScene packedMesh = null) : base(inputSlots, packedMesh)
	{
	...
	{
		double coef = GD.RandRange(1f - statRandRange, 1f + statRandRange);
